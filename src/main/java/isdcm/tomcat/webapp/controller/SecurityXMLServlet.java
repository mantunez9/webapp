...
public class SecurityXMLServlet {
    ...
    public String doPost(HttpServletRequest req, HttpServletResponse resp) {
        try {
            ...
            switch (option) {
                case "enc":
                    encrypt(xmlDocument, node, outputFile, encryptContentsOnly);
                    break;
                case "dec":
    ...
    public static void encrypt(Document doc, String node, String outputFile, boolean encryptContentsOnly) throws XMLEncryptionException, Exception {
        ...
        if (outputFile.isEmpty())
            outputDocToFile(doc, "C:\\Users\\gessi\\IdeaProjects\\webapp\\src\\main\\webapp\\xml\\encryptedInfo.xml");
        else
    ...
    public static void decrypt(Document doc, String outputFile, boolean encryptContentsOnly) throws XMLEncryptionException, Exception {
        ...
        if (outputFile.isEmpty())
            outputDocToFile(doc, "C:\\Users\\gessi\\IdeaProjects\\webapp\\src\\main\\webapp\\xml\\decryptedInfo.xml");
        else
            outputDocToFile(doc, outputFile);
    }
